			...
			<div class="row g-row-col--5 g-margin-b-50--xs">
				<div class="container"> 
					...
					<div class = "row" style="margin-bottom: 20px">
						<form action="writeTeamAction.jsp" method="post" enctype="multipart/form-data">
							<strong>Member ID Photo</strong> <input type="file" name="file">
						</div>
						<div class="row">
							<div class="form-group row">
								<label for="inputName" class="col-sm-2 col-form-label"><strong>이름</strong></label>
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Member Name" name="memberName" maxlength="50">
								</div>
							</div>
							<div class="form-group row">
								<label for="inputIntroduction" class="col-sm-2 col-form-label"><strong>역활소개</strong></label>
								<div class="col-sm-10">
									<textarea class="form-control" placeholder="Member Introduction" name="memberIntro" maxlength="2048" style="height:350px;"></textarea>
								</div>
							</div>
