			...
			<div class="col-md-6 col-md-offset-3">
				<div class="blogs">
					<div class="text-center">
						<h2>Research</h2>
						<p>
							자율로봇 및 인공지능 연구실은 2018년에 만들어진 신생 연구실이며,<br> 최근 각광받고 있는 분야인
							인공지능과 로보틱스를 결합하<br> 지능을 가지고 인간과 함께 공존하며 다양한 일을 할 수 있는<br>로봇
							시스템을 만드는 것을 목표로 하고 있습니다. <br>
						</p>
					</div>
					<hr>
				</div>
					...
					<div class="col-md-12">
						...
						<div class="page-header">
							...
							<%
									if(userID != null){
							%>
							<!-- <a href="update.jsp?bbsID=<%=list.get(i).getBbsID()%>" class="btn btn-primary pull-right" style="background-color: black">수정</a> -->
							<a href="deleteAction.jsp?bbsID=<%=list.get(i).getBbsID()%>" class="btn btn-primary pull-right" style="background-color: black">삭제</a>
							<%
							}
							%>
						</div>
						...
						<div style = "margin-top:10px">
							<a href="writeResearch.jsp" class="btn btn-primary pull-right" style="background-color: tomato">연구 추가하기</a>
						</div>
						<%
						}
						%>
