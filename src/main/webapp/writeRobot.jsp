			...
			<div class="row g-row-col--5 g-margin-b-50--xs">
				<div class="container"> 
					...
					<div class = "row" style="margin-bottom: 20px">
						<form action="writeRobotAction.jsp" method="post" enctype="multipart/form-data">
							<strong>로봇 사진</strong> <input type="file" name="file">
						</div>
						<div class="row">
							<div class="form-group row">
								<label for="inputTitle" class="col-sm-2 col-form-label"><strong>제목</strong></label>
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="로봇 제목" name="robotTitle" maxlength="100">
								</div>
							</div>
							<div class="form-group row">
								<label for="inputContent" class="col-sm-2 col-form-label"><strong>내용</strong></label>
								<div class="col-sm-10">
									<textarea class="form-control" placeholder="간락한 설명" name="robotContent" maxlength="10000" style="height:350px;"></textarea>
								</div>
							</div>
